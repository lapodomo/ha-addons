...
deploy_challenge() {
    ...
    bashio::log.info " + Record bijwerken voor dns challenge $ALIAS $TOKEN_VALUE"
    dns_challenge_add $ALIAS $TOKEN_VALUE
    bashio::log.info " + Settling down for 75s..."
    sleep 75
...
clean_challenge() {
    ...
    delete_dns_record $ALIAS $TOKEN_VALUE
}
